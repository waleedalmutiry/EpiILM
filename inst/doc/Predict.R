...
###################################################
### code chunk number 1: Predict.Rnw:37-42
###################################################
...
###################################################
### code chunk number 2: Predict.Rnw:44-52
###################################################
set.seed(101)
n <- 100
...
###################################################
### code chunk number 3: Predict.Rnw:62-66
###################################################
set.seed(101)
...
###################################################
### code chunk number 4: Predict.Rnw:70-75
###################################################
...
###################################################
### code chunk number 6: Predict.Rnw:84-92
###################################################
set.seed(101)
pred.net.5 <- pred.epi(netdat, xx = mcmcout_net, tmin = 5,
                       burnin = 1000, criterion = "newly infectious",
                       n.samples = 500)
pred.net.8 <- pred.epi(netdat, xx = mcmcout_net, tmin = 8,
                       burnin = 1000, criterion = "newly infectious",
                       n.samples = 500)
...
###################################################
### code chunk number 9: Predict.Rnw:114-123
###################################################
...
###################################################
### code chunk number 11: Predict.Rnw: 150-157
###################################################
set.seed(101)
...
###################################################
### code chunk number 13: Predict.Rnw: 166-174
###################################################
set.seed(101)
...
model2.data <- as.epidata(type = "SI", n = 100, x = x, y = y, inftime = SI.cov$inftime)
...
###################################################
### code chunk number 16: Predict.Rnw:191-197
###################################################
loglike <- epilike(SI.cov, tmax = t_end, Sformula = ~A,
                                         sus.par = c(0.597, 1.071), beta = 6.606)
...
###################################################
### code chunk number 17: Predict.Rnw:200-204
###################################################
